...
const roles = ["C++ Developer", "Frontend Developer", "JavaScript Enthusiast", "Problem Solver"];
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            ...
            <span className="text-accent font-mono">JavaScript</span>, and currently learning{" "}
            <span className="text-primary font-mono">React.js</span>.
          </p>
